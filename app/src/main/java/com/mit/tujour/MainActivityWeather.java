package com.mit.tujour;

import static com.mit.tujour.R.layout.popup_card_weather;
...
import com.mit.tujour.Adapter.overmorrowAdapter;
import com.mit.tujour.Adapter.tomorrowAdapter;
import com.mit.tujour.Adapter.weatherAdapter;
import com.mit.tujour.Datamodel.conditonData;
import com.mit.tujour.Datamodel.weatherData;
...
//        rv_parent_tday.startShimmer();
        ...
        /*card_view_btn.setOnClickListener(view -> {
            if (result != null) {
                if (mInterstitialAd != null) {
                    mInterstitialAd.show(MainActivityWeather.this);
                } else {
                    Log.d("TAG", "The interstitial ad wasn't ready yet.");
                }
                showPopUp();
            } else {
                Toast.makeText(MainActivityWeather.this, "Wait until data loaded..", Toast.LENGTH_SHORT).show();
            }
    ...
    private void showPopUp() {
        ...
        ((ViewGroup) dialog.getWindow().getDecorView()).getChildAt(0).startAnimation(AnimationUtils.loadAnimation(MainActivityWeather.this, android.R.anim.slide_in_left));
        dialog.show();
    }
        ...
        AndroidNetworking.get(base_url).setPriority(Priority.HIGH).build().getAsJSONObject(new JSONObjectRequestListener() {
            ...
            public void onResponse(JSONObject response) {
                ...
                if (response != null) {
                    ...
                    Toast.makeText(MainActivityWeather.this, "Sorry...", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void overmorrowData(JSONArray overmorrow_hour) {
        ...
        for (int i = overmorrow_hour.length() - 1; i >= 0; i--) {
            try {
                ...
                overmorrowAdapter adapter3 = new overmorrowAdapter(weatherDataArrayList2, conditonDataArrayList2, MainActivityWeather.this);
    ...
    private void tomorrowData(JSONArray tomorrow_hour) {
        ...
        for (int i = tomorrow_hour.length() - 1; i >= 0; i--) {
            ...
            try {
                ...
                tomorrowAdapter adapter2 = new tomorrowAdapter(weatherDataArrayList1, conditonDataArrayList1, MainActivityWeather.this);
    ...
    private void todaySetData(JSONArray tdy_hour) {
        for (int i = tdy_hour.length() - 1; i >= 0; i--) {
            try {
                ...
                //Setting adapter
                weatherAdapter adapter = new weatherAdapter(MainActivityWeather.this, weatherDataList, conditonDataArrayList);
